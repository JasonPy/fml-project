...
MAX_GAME_STEPS = 401
NUMBER_EPISODES = 756000

# external file locations
MODEL = "../models/testmodel_22-03_19-30/model"
MODEL_TARGET = "../models/pretrain_target_v6"
...
def setup(self):
    ...
    if self.train:
        ...
        with open("../models/testmodel_22-03_19-30/model", "rb") as file:
