...
def setup_training(self):
    ...
    if PRE_TRAIN:
        pre_train_agent(self, "../training_data/h5f_train_data_new_coin_features.h5", 1000000)
...
def end_of_round(self, last_game_state: dict, last_action: str, events: List[str]):
    ...
    self.writer.add_scalar("Step per epoch", self.step_per_epoch, self.number_of_epoch)
